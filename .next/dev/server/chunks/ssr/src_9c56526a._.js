...
const AdminDashboardContent = ()=>{
    ...
    const confirmStatusUpdate = async ()=>{
        ...
        if (!id || !type) return;
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('transactions').update({
                status: type
            }).eq('id', id);
            if (error) throw error;
            // Optimistic update
...
//# sourceMappingURL=src_9c56526a._.js.map