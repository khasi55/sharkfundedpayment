...
"[project]/src/app/api/create-order/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('transactions').insert([
            {
                amount: amount,
                ...
                utr: `ORDER-${Date.now()}-${Math.random().toString(36).substring(7)}`
            }
        ]).select().single();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__67e8c21e._.js.map