...
"[project]/src/app/api/send-receipt/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        // 1. Fetch Transaction
        const { data: transaction, error } = await supabase.from('transactions').select('*').eq('utr', utr).single();
        ...
        if (transaction.status !== 'verified') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: 'Transaction is not verified yet'
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__503edc77._.js.map