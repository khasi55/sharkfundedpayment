...
function PropFirmCheckout() {
    ...
    const PLANS = [
        ...
        // { id: '50k', name: '50K Challenge', price: 4999, label: '$50,000 Account' }, // temporarily hidden
        {
            id: '100k',
            name: '100K Challenge',
            price: 29999,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PropFirmCheckout.useEffect": ()=>{
            // console.log("Init checkout with:", sessionId);
            const qAmount = searchParams.get('amount');
            if (qAmount) {
                const plan = PLANS.find({
                    "PropFirmCheckout.useEffect.plan": (p)=>p.price.toString() === qAmount
                }["PropFirmCheckout.useEffect.plan"]);
                if (plan) setSelectedPlan(plan.id);
                setState({
                    "PropFirmCheckout.useEffect": (s)=>({
                            ...s,
                            amount: qAmount
                        })
                }["PropFirmCheckout.useEffect"]);
    ...
    const fetchTransaction = async ()=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select('*').or(`id.eq.${sessionId},session_id.eq.${sessionId}`).single();
            if (data) {
                ...
                const match = PLANS.find((p)=>p.price.toString() == data.amount);
                if (match) setSelectedPlan(match.id);
            }
        } catch (e) {
            console.log("Error loading tx:", e);
        }
    };
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            // basic validation
            if (!state.email || !state.firstName || !state.phone) {
            ...
            // DB Upsert
            const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select('id').eq('session_id', sessionId).single();
            if (existing) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').update(payload).eq('session_id', sessionId);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').insert([
                    payload
                ]);
            }
            // Redirect
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen bg-[#F0F2F5] flex justify-center p-4",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "bg-white w-full max-w-5xl rounded-2xl shadow-xl flex flex-col md:flex-row overflow-hidden min-h-[600px]",
            children: [
...
_s(PropFirmCheckout, "svCZ6J7D4cdMEV057RUwmN1XsMI=", false, function() {
    return [
...
"[project]/src/components/checkout/SecureLoadingScreen.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SecureLoadingScreen = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SecureLoadingScreen.useEffect": ()=>{
            const timers = [
                setTimeout({
                    "SecureLoadingScreen.useEffect": ()=>setLoadingStep(1)
                }["SecureLoadingScreen.useEffect"], 500),
                setTimeout({
                    "SecureLoadingScreen.useEffect": ()=>setLoadingStep(2)
                }["SecureLoadingScreen.useEffect"], 1200),
                setTimeout({
                    "SecureLoadingScreen.useEffect": ()=>setLoadingStep(3)
                }["SecureLoadingScreen.useEffect"], 2000)
            ];
            return ({
                "SecureLoadingScreen.useEffect": ()=>timers.forEach(clearTimeout)
            })["SecureLoadingScreen.useEffect"];
        }
    }["SecureLoadingScreen.useEffect"], []);
    const steps = [
...
_s(SecureLoadingScreen, "pazf76eUfQGZnXnajLEmKYQoHSw=");
_c = SecureLoadingScreen;
const __TURBOPACK__default__export__ = SecureLoadingScreen;
var _c;
__turbopack_context__.k.register(_c, "SecureLoadingScreen");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/check.js [app-client] (ecmascript) <export default as Check>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$checkout$2f$SecureLoadingScreen$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/checkout/SecureLoadingScreen.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
function PaymentPageContent() {
    ...
    // Separate states for random things (classic inconsistent human code)
    ...
    const [timeLeft, setTimeLeft] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(900); // 15 mins
    const [verifyingText, setVerifyingText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Verifying...');
    // UPI setup
    ...
    const upiUrl = `upi://pay?pa=${vpa}&pn=${encodeURIComponent(merchantName)}&am=${state.amount}&cu=INR`;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PaymentPageContent.useEffect": ()=>{
            ...
            if (qAmount && qName && qEmail) {
                console.log("Auto-filling from URL");
                const isEmail = qEmail.includes('@');
                setState({
    ...
    const loadOrder = async ()=>{
        try {
            // console.log("Fetching order:", urlSessionId);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PaymentPageContent.useEffect": ()=>{
            if (state.step === 'payment' && timeLeft > 0) {
                const t = setInterval({
                    "PaymentPageContent.useEffect.t": ()=>setTimeLeft({
                            "PaymentPageContent.useEffect.t": (prev)=>prev - 1
                        }["PaymentPageContent.useEffect.t"])
                }["PaymentPageContent.useEffect.t"], 1000);
                return ({
                    "PaymentPageContent.useEffect": ()=>clearInterval(t)
                })["PaymentPageContent.useEffect"];
            } else if (timeLeft === 0 && state.step === 'payment') {
                setState({
                    "PaymentPageContent.useEffect": (s)=>({
                            ...s,
                            step: 'expired'
                        })
                }["PaymentPageContent.useEffect"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PaymentPageContent.useEffect": ()=>{
            if (!sessionId) return;
            const sub = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel(`txn_${sessionId}`).on('postgres_changes', {
                event: 'UPDATE',
                schema: 'public',
                table: 'transactions',
                filter: `session_id=eq.${sessionId}`
            }, {
                "PaymentPageContent.useEffect.sub": (payload)=>{
                    const status = payload.new.status;
                    if (status === 'verified') {
                        if (payload.new.order_id) setOfficialOrderId(payload.new.order_id);
                        setState({
                            "PaymentPageContent.useEffect.sub": (s)=>({
                                    ...s,
                                    step: 'verified'
                                })
                        }["PaymentPageContent.useEffect.sub"]);
                        // send receipt
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/send-receipt', {
                            ...
                            "PaymentPageContent.useEffect.sub": (err)=>console.log("Receipt error", err)
                        }["PaymentPageContent.useEffect.sub"]);
            ...
            }["PaymentPageContent.useEffect.sub"]).subscribe();
            return ({
                "PaymentPageContent.useEffect": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].removeChannel(sub);
                }
            })["PaymentPageContent.useEffect"];
        }
    }["PaymentPageContent.useEffect"], [
    ...
    // Fake loading screen state
    const [initLoading, setInitLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PaymentPageContent.useEffect": ()=>{
            setTimeout({
                "PaymentPageContent.useEffect": ()=>setInitLoading(false)
            }["PaymentPageContent.useEffect"], 1200);
        }
    }["PaymentPageContent.useEffect"], []);
    const doSubmit = (e)=>{
        e.preventDefault();
        if (!state.amount || !state.email) {
            setState((s)=>({
                    ...s,
    ...
    const verifyPayment = async ()=>{
        if (state.utr.length != 12) {
            alert("UTR must be 12 digits");
            return;
        }
        setState((s)=>({
                ...s,
        ...
        try {
            ...
            const { data: dup } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select('*').eq('utr', state.utr).eq('status', 'verified').single();
            if (dup) {
                setState((s)=>({
                        ...s,
                        step: 'failed',
                        error: 'UTR already verified'
                    }));
                return;
            }
            // Call API
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/verify-payment', {
                utr: state.utr,
                amount: state.amount,
                orderId: sessionId,
                email: state.email,
            ...
            if (res.data.success) {
                // Update DB locally just in case
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').update({
                    status: 'verified',
                    utr: state.utr,
                    amount: state.amount,
                    customer_details: {
    ...
    if (initLoading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$checkout$2f$SecureLoadingScreen$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "md:w-[320px] bg-slate-50 border-r border-slate-200 p-8 hidden md:block",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mb-8",
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "inline-flex items-center gap-1 mt-2 px-2 py-1 bg-white border rounded text-xs text-slate-500",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shield$2d$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ShieldCheck$3e$__["ShieldCheck"], {
                                            size: 12,
                                            className: "text-emerald-500"
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "text-xs uppercase text-slate-400 font-bold mb-1",
                                    children: "Total Due"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/PaymentPageContent.tsx",
                                    lineNumber: 224,
                        ...
                        officialOrderId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "bg-green-50 text-green-800 p-3 rounded border border-green-200 mb-6",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "border-t pt-6 text-xs text-slate-400",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        state.step === 'payment' && mode !== 'payment' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            className: "absolute top-6 left-6 text-slate-400 hover:text-slate-600 flex items-center gap-1 text-sm font-bold",
                            children: [
                            ...
                            children: [
                                state.step === 'details' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                    className: "text-sm text-slate-600 font-bold block mb-1",
                                                    children: "Email"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/PaymentPageContent.tsx",
                                                    lineNumber: 258,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    ...
                                                    value: state.amount,
                                                    disabled: true,
                                                    className: "w-full border p-2.5 rounded bg-slate-50 text-slate-500"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/PaymentPageContent.tsx",
                                                    lineNumber: 267,
                                                    columnNumber: 37
                                ...
                                state.step === 'payment' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "text-amber-600 text-xs font-bold bg-amber-50 inline-block px-3 py-1 rounded-full mb-6",
                                            children: [
                                                "Expires in ",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "bg-white p-2 border rounded-xl inline-block shadow-sm hover:shadow-md cursor-pointer relative",
                                            onClick: ()=>copyTxt(upiUrl),
                                            children: [
                                                ...
                                                copied && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "absolute inset-0 bg-white/90 flex items-center justify-center font-bold text-sm",
                                                    children: "Copied!"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/PaymentPageContent.tsx",
                                                    lineNumber: 285,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-slate-700 font-mono bg-slate-100 px-3 py-1 rounded inline-flex items-center gap-2 cursor-pointer",
                                                    onClick: ()=>copyTxt(vpa),
                                                    children: [
                                                        vpa,
                                                        " ",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                    className: "block text-left text-sm font-bold text-slate-700 mb-2",
                                                    children: "Transaction UTR / Ref ID"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/PaymentPageContent.tsx",
                                                    lineNumber: 296,
                                                    columnNumber: 37
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            ...
                                                            className: "bg-black text-white px-4 py-2 rounded font-bold text-sm hover:bg-slate-800",
                                                            children: state.step === 'verifying' ? 'Checking...' : 'Verify'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/PaymentPageContent.tsx",
                                                            lineNumber: 306,
                                                            columnNumber: 41
                                                ...
                                                state.error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-left text-red-500 text-xs mt-2 mt-2",
                                                    children: state.error
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/PaymentPageContent.tsx",
                                                    lineNumber: 310,
                                ...
                                (state.step === 'success' || state.step === 'verified') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "We've received your payment."
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/PaymentPageContent.tsx",
                                            lineNumber: 321,
                                            columnNumber: 33
                                        ...
                                        officialOrderId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "font-mono font-bold bg-slate-100 p-2 rounded inline-block",
                                            children: officialOrderId
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/PaymentPageContent.tsx",
                                            lineNumber: 322,
...
_s(PaymentPageContent, "5MklLHTdltx0x0uS4OGZQe6njA4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"]
    ];
...
//# sourceMappingURL=src_8b18007c._.js.map