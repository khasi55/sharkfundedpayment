...
function PropFirmCheckout() {
    ...
    const router = __turbopack_context__.r("[project]/node_modules/next/navigation.js [app-client] (ecmascript)").useRouter();
    const handlePlaceOrder = async (e)=>{
        ...
        try {
            ...
            const { error: dbError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').upsert([
                {
...
_s(PropFirmCheckout, "1/jqhUD3LWT1NaemFvcX5Yul4XU=", false, function() {
    return [
...
//# sourceMappingURL=src_92b53676._.js.map