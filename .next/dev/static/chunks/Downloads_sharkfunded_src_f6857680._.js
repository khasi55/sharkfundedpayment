...
const AdminDashboard = ()=>{
    ...
    const [dateFilter, setDateFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$sharkfunded$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('all'); // 'all', 'today', 'week', 'month'
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$sharkfunded$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
            ...
            const subscription = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$sharkfunded$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel('transactions_channel').on('postgres_changes', {
                ...
                "AdminDashboard.useEffect.subscription": (payload)=>{
                    console.log('Real-time change:', payload);
                    if (payload.eventType === 'INSERT') {
                        setTransactions({
                            "AdminDashboard.useEffect.subscription": (prev)=>[
                                    payload.new,
                                    ...prev
                                ]
                        }["AdminDashboard.useEffect.subscription"]);
                    } else if (payload.eventType === 'UPDATE') {
                        setTransactions({
                            "AdminDashboard.useEffect.subscription": (prev)=>prev.map({
                                    "AdminDashboard.useEffect.subscription": (t)=>t.id === payload.new.id ? payload.new : t
                                }["AdminDashboard.useEffect.subscription"])
                        }["AdminDashboard.useEffect.subscription"]);
                    } else if (payload.eventType === 'DELETE') {
                        setTransactions({
                            "AdminDashboard.useEffect.subscription": (prev)=>prev.filter({
                                    "AdminDashboard.useEffect.subscription": (t)=>t.id !== payload.old.id
                                }["AdminDashboard.useEffect.subscription"])
                        }["AdminDashboard.useEffect.subscription"]);
                    }
                }
            }["AdminDashboard.useEffect.subscription"]).subscribe({
                "AdminDashboard.useEffect.subscription": (status)=>{
    ...
    const users = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$sharkfunded$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "AdminDashboard.useMemo[users]": ()=>{
            const userMap = new Map();
            transactions.forEach({
                "AdminDashboard.useMemo[users]": (t)=>{
            ...
            return Array.from(userMap.values()).sort({
                "AdminDashboard.useMemo[users]": (a, b)=>b.totalSpend - a.totalSpend
            }["AdminDashboard.useMemo[users]"]);
        }
    }["AdminDashboard.useMemo[users]"], [
        transactions
    ...
    const formatDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$sharkfunded$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDashboard.useCallback[formatDate]": (dateString)=>{
    ...
    }["AdminDashboard.useCallback[formatDate]"], []);
    const formatTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$sharkfunded$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDashboard.useCallback[formatTime]": (dateString)=>{
            return new Intl.DateTimeFormat('en-US', {
                hour: 'numeric',
                minute: 'numeric',
                hour12: true
    ...
    }["AdminDashboard.useCallback[formatTime]"], []);
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$sharkfunded$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[stats]": ()=>{
            const totalRevenue = transactions.filter({
                "AdminDashboard.useMemo[stats].totalRevenue": (t)=>t.status === 'verified'
            }["AdminDashboard.useMemo[stats].totalRevenue"]).reduce({
                "AdminDashboard.useMemo[stats].totalRevenue": (sum, t)=>sum + Number(t.amount)
            ...
            const approvedCount = transactions.filter({
                "AdminDashboard.useMemo[stats]": (t)=>t.status === 'verified'
            }["AdminDashboard.useMemo[stats]"]).length;
            const pendingCount = transactions.filter({
                "AdminDashboard.useMemo[stats]": (t)=>t.status === 'pending_manual_verification'
            }["AdminDashboard.useMemo[stats]"]).length;
            const failedRejectedCount = transactions.filter({
                "AdminDashboard.useMemo[stats]": (t)=>t.status === 'failed' || t.status === 'rejected'
            }["AdminDashboard.useMemo[stats]"]).length;
            const totalUsers = new Set(transactions.map({
                "AdminDashboard.useMemo[stats]": (t)=>t.customer_details?.email
            }["AdminDashboard.useMemo[stats]"])).size;
            const todayTransactions = transactions.filter({
                "AdminDashboard.useMemo[stats].todayTransactions": (t)=>new Date(t.created_at).toDateString() === new Date().toDateString()
            }["AdminDashboard.useMemo[stats].todayTransactions"]);
            const todayCount = todayTransactions.length;
            const todayVolume = todayTransactions.filter({
                "AdminDashboard.useMemo[stats].todayVolume": (t)=>t.status === 'verified'
            }["AdminDashboard.useMemo[stats].todayVolume"]).reduce({
                "AdminDashboard.useMemo[stats].todayVolume": (sum, t)=>sum + Number(t.amount)
            }["AdminDashboard.useMemo[stats].todayVolume"], 0);
            return {
                totalRevenue,
                totalPayments,
                approvedCount,
...
_s(AdminDashboard, "uPJZD34Gy5g6x67fJ8tnG0hNbM4=", false, function() {
    return [
...
//# sourceMappingURL=Downloads_sharkfunded_src_f6857680._.js.map